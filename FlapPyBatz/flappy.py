...
PLAYERS_LIST = (
    # 
    (
        'assets/sprites/bat1.png',
        'assets/sprites/bat1.png',
        'assets/sprites/bat1.png',
    ),
    # 
    (
        'assets/sprites/bat2.png',
        'assets/sprites/bat2.png',
        'assets/sprites/bat2.png',
    ),
    # 
    (
        'assets/sprites/bat3.png',
        'assets/sprites/bat3.png',
        'assets/sprites/bat3.png',
    ),
    # 
    (
        'assets/sprites/bat4.png',
        'assets/sprites/bat4.png',
        'assets/sprites/bat4.png',
    ),
    # 
    (
        'assets/sprites/bat5.png',
        'assets/sprites/bat5.png',
        'assets/sprites/bat5.png',
    ),
)
...
def checkCrash(player, upperPipes, lowerPipes):
    ...
    if player['y'] + player['h'] >= BASEY - 1:
        ...
        for uPipe, lPipe in zip(upperPipes, lowerPipes):
            ...
            # if batz collided with upipe or lpipe
